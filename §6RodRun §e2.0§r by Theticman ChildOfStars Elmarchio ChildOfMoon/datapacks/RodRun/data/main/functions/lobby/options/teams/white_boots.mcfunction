...
# Give item back
replaceitem entity @s[tag=Test_boots] armor.feet minecraft:leather_boots{display:{color:16777215,Name:'[{"text":"White","color":"white"},{"text":" boots","color":"yellow"}]'},HideFlags:63,Unbreakable:1b}
