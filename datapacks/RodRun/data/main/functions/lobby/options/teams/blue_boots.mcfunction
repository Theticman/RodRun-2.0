...
# Give item back
replaceitem entity @s[tag=Test_boots] armor.feet minecraft:leather_boots{display:{color:3708879,Name:'[{"text":"Blue","color":"blue"},{"text":" boots","color":"yellow"}]'},HideFlags:63,Unbreakable:1b}
